...
def generate_cirr_test_submissions(combining_function: callable, file_name: str, blip_textual, blip_multimodal, 
...
def generate_cirr_test_dicts(relative_test_dataset: CIRRDataset, blip_textual, blip_multimodal, index_features: torch.tensor,
    ...
    predicted_features, reference_names, group_members, pairs_id = \
        generate_cirr_test_predictions(blip_textual, blip_multimodal, relative_test_dataset, combining_function, index_names,
                                       index_features)
...
def generate_cirr_test_predictions(blip_textual, blip_multimodal, relative_test_dataset: CIRRDataset, combining_function: callable,
...
def main():
    ...
    generate_cirr_test_submissions(combining_function, args.submission_name, blip_textual, blip_multimodal, blip_visual, preprocess)
